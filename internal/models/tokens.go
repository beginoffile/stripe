...
const (
	ScopeAuthentication = "autehentication"
)
...
// GenerateToken generates a token that last for ttl, and return it
...
func (m *DBModel) GetUserByToken(token string) (*User, error) {
	...
	query := `Select t1.id, t1.first_name, t1.last_name, t1.email
	From Users t1
